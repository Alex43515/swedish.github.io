        ...
        $settings_fields = [
            ...
            'element_pack_api_settings'     => [
                ...
                [
                    ...
                    'desc'              => __('Go to <a href="https://openweathermap.org/" target="_blank">https://openweathermap.org/</a> > Copy Key and Paste here.', 'bdthemes-element-pack'),
                    'placeholder'       => '',
                    'type'              => 'text',
                    'sanitize_callback' => 'sanitize_text_field'
                ],
          ...
          <div class="bdt-width-1-3@m">
            <div class="ep-video-tutorial bdt-card bdt-card-body bdt-card-green">
              ...
              <ul class="bdt-list bdt-list-divider" bdt-lightbox>
                <li>
                  <a href="https://youtu.be/LsGX1NeKcjg">
                    <h4 class="ep-link-title">What's New in Version V5.8.0</h4>
                  </a>
                </li>
                <li>
