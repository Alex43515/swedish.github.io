        ...
        $this->add_control(
            ...
            [
                ...
                'options'     => [
                    ...
                    '11' => esc_html__( '1:1', 'bdthemes-element-pack' ),
                    '21' => esc_html__( '2:1', 'bdthemes-element-pack' ),
                    '32' => esc_html__( '3:2', 'bdthemes-element-pack' ),
                    '43' => esc_html__( '4:3', 'bdthemes-element-pack' ),
                    '85' => esc_html__( '8:5', 'bdthemes-element-pack' ),
                    '169' => esc_html__( '16:9', 'bdthemes-element-pack' ),
                    '219' => esc_html__( '21:9', 'bdthemes-element-pack' ),
                    '916' => esc_html__( '9:16', 'bdthemes-element-pack' ),
                ],
