            ...
            $this->add_control(
                ...
                [
                    ...
                    'options' => [
                        ...
                        'static'   => __('Static', 'bdthemes-element-pack'),
                    ],
                ]
            );
...
//            );
            ...
            $repeater->start_controls_tab('tabs_static_column_style',
                [
            ...
            $repeater->start_controls_tab('tabs_static_row_style',
                [
                    'label'     => __('Style', 'bdthemes-element-pack'),
                    'condition' => [
                        'static_row_column_type' => 'column'
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors'  => [
                        '{{WRAPPER}} .bdt-table td' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                    ],
                ]
            );
                ...
                <?php foreach ($settings['static_columns_data'] as $index => $column_cell) :
                  ...
                  <th <?php echo $this->get_render_attribute_string($column_repeater_key); ?>>
                    <div class="bdt-static-column-cell-wrap">
                      ...
                      <div
                          class="bdt-static-column-cell-text"><?php echo $column_cell['static_column_name']; ?></div>
                          ...
                          if ($static_table_row[$i]['id'] == $static_table_cell[$j]['row_id']) :
                            ...
                            <td <?php echo $this->get_render_attribute_string($row_span_repeater_key); ?>>
                              ...
                              <div class="bdt-static-body-row-cell-wrap">
                                <div
                                    class="bdt-static-body-row-cell-text"><?php echo $static_table_cell[$j]['title']; ?></div>
                                  ...
                                  <?php
                                      if (isset($static_table_cell[$j]['static_row_image']['url']) || isset($static_table_cell[$j]['static_row_image']['id'])) :
                                          $image = wp_get_attachment_image_url($static_table_cell[$j]['static_row_image']['id'], $static_table_cell[$j]['static_row_thumbnail_size']);
                                          if (!$image) {
                                              $image = $static_table_cell[$j]['static_row_image']['url'];
                                          }
                                          ?>
                                        <div class="bdt-static-body-row-cell-icon">
                                          <img src="<?php echo esc_url($image); ?>"
                                               alt="<?php echo esc_attr($static_table_cell[$j]['title']); ?>">
                                        </div>
                                      <?php endif; ?>
                              </div>
