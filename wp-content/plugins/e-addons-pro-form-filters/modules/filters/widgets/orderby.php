 ...
 *
 */
class Orderby extends \ElementorPro\Modules\Forms\Widgets\Form {
    ...
    public function get_icon() {
        return 'eadd-el-form-pro-filters-orderby';
    }
                ...
                [
                    ...
                    'default' => [
                        [
                            'custom_id' => 'order_by',
                            'field_type' => 'select',
                            'field_label' => __('Order By', 'elementor-pro'),
                            'placeholder' => __('Order By', 'elementor-pro'),
                            'field_options' => 'Default|' . PHP_EOL . 'Newest|date/DESC' . PHP_EOL . 'Title A-Z|title/ASC' . PHP_EOL . 'Title Z-A|title/DESC',
                        ],
                    /* [
                      'custom_id' => 'orderby',
                      'field_type' => 'select',
                      'field_label' => __('Order by', 'elementor-pro'),
                      'placeholder' => __('Order by', 'elementor-pro'),
                      'field_options' => 'Title|title' . PHP_EOL . 'Date|date',
                      'width' => '60',
                      ],
                      [
                      'custom_id' => 'order',
                      'field_type' => 'radio',
                      'required' => 'true',
                      'field_label' => __('Order', 'elementor-pro'),
                      'field_options' => 'ASC' . PHP_EOL . 'DESC',
                      'width' => '40',
                      ], */
                    ],
    ...
    public function render_orderby($fields = array(), $form_settings = array(), $form_settings_raw = array()) {
        $settings = $this->get_settings_for_display();
        if (empty($settings))
            return;
    }
